###########################################################################
## Makefile generated for component 'stabil'. 
## 
## Makefile     : stabil.mk
## Generated on : Tue Oct 03 12:29:30 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/stabil
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/stabil
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/eriknymobohne/Documents/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/ev3/include -I$(START_DIR)/stabil_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(EV3_LMSTYPES_DIR)/.. -I$(EV3_LMS2012_DIR)/.. -I$(EV3_BYTECODES_DIR)/.. -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc -I/Users/eriknymobohne/Documents/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/ev3/src
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_RTT_LCD_=7
...
DEFINES_STANDARD = -DMODEL=stabil -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = rtGetInf.o rtGetNaN.o rt_nonfinite.o stabil.o stabil_data.o linuxinitialize.o driver_ev3_button.o driver_ev3_lcd.o MW_legoev3init.o driver_pixy2_vision_sensor.o driver_ev3_encoder.o driver_ev3_gyro_sensor.o driver_ev3_motor.o
...
%.o : $(START_DIR)/stabil_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/stabil_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/stabil_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/stabil_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/stabil_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/stabil_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stabil.o : $(START_DIR)/stabil_ert_rtw/stabil.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stabil_data.o : $(START_DIR)/stabil_ert_rtw/stabil_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
